...
func (h *SnippetHandler) handleCreate(msg *models.IPCMessage, writer ResponseWriter) error {
	...
	snippet, err := h.manager.Create(req.Name, req.Command, req.Description, req.Tags)
	if err != nil {
		return err
	}
...
func (h *SnippetHandler) handleUpdate(msg *models.IPCMessage, writer ResponseWriter) error {
	...
	snippet, err := h.manager.Update(req.ID, req.Name, req.Command, req.Description, req.Tags)
	if err != nil {
		return err
	}

...
func (m *Manager) Create(name, command, description string, tags []string) (*models.Snippet, error) {
...
func (m *Manager) Update(id, name, command, description string, tags []string) (*models.Snippet, error) {

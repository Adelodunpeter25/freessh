...
export function ConnectionFormScreen({ route, navigation }: Props) {
  ...
  return (
    <YStack flex={1}>
      ...
      />
      <Screen keyboardAvoiding keyboardOffset={100}>
        <YStack gap="$4">
          {/* General Section */}
          <YStack gap="$4">
              ...
              <YStack gap="$2">
                ...
                <XStack alignItems="center" position="relative">
                  ...
                  <IconButton
                    ...
                    icon={
                      showPassword ? (
                        <EyeOff size={20} color={t.color.get()} />
                      ) : (
                        <Eye size={20} color={t.color.get()} />
                      )
                    }
                  />
                </XStack>
              ...
              <YStack gap="$4">
                <RadioGroup
                  ...
                  onValueChange={(value: string) =>
                    setKeyMode(value as "existing" | "new")
                  }
                >
                  <XStack gap="$4">
                    <XStack gap="$2" alignItems="center">
                  ...
                  <Select
                    ...
                    options={[
                      ...(keys.length > 0
                        ...
                        : [
                            {
                              label: "No keys available. Create one first.",
                              value: "",
                            },
                          ]),
                    ]}

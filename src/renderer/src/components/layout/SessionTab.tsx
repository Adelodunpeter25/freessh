      ...
      <div
        className={cn(
          ...
          isActive
            ...
            : 'bg-card/90 border-zinc-300 text-foreground/70 hover:bg-muted/40 hover:border-zinc-400 dark:bg-white/5 dark:border-white/10 dark:text-foreground/80 dark:hover:bg-white/10 dark:hover:border-white/20'
        )}
        style={noDrag}
